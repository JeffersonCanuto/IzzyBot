...
const ConversationList:React.FC<ConversationListProps> = ({ 
    ...
    return (
        <div className="flex flex-col border rounded-md w-64 bg-gray-50 p-4 h-[550px] overflow-y-auto">
            <div className="flex justify-between border-b pb-3 mb-4">
                <h2 className="text-xl font-bold text-gray-500">Conversations</h2>
                                        ...
                                        <div className="flex flex-col">
                                            {editingId === conv.id ? (
                                                <input
                                                    ...
                                                    onKeyDown={e => {
                                                        if (e.key === "Enter") handleLabelFinishEdit();
                                                    }}
                                                    autoFocus
                                                    maxLength={14}
                                                ...
                                                <span className="text-gray-900 text-[14px] ml-3">
                                                    {labels[conv.id]}
                                                </span>
                                            )}
