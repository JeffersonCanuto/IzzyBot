...
const ChatWindow:React.FC<ChatWindowProps> = ({ messages }) => {
    return (
        <div className="flex flex-col">
            <div className="flex flex-row gap-3 items-center bg-gray-50 border border-gray-300 rounded-md py-3 px-5">
            ...
            <div
                className="flex flex-col gap-2 p-4 h-[418px] overflow-y-auto border rounded-md bg-white"
                style={{
